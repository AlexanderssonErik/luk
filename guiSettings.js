...
let guiSettings = {
    ...
    init : function(scene){
        ...
        iconPath[3] = [];
        iconPath[3][0] = "./icon/settings_compass.svg"
        iconPath[3][1] = "./icon/settings_compass_off.svg"
        iconPath[3][2] = "./icon/settings_compass_on.svg"

        iconPath[4] = [];
        iconPath[4][0] = "./icon/settings_compass.svg"
        iconPath[4][1] = "./icon/settings_compass_off.svg"
        iconPath[4][2] = "./icon/settings_compass_on.svg"
        ...
        this.buttons[3][1].initCallBack(this.clickCompassOff, buttonTrigger.up);
        this.buttons[3][2].initCallBack(this.clickCompassOn, buttonTrigger.up);
