...
let projection = {
  ...
  init: function(scene){
    ...
    this.materialsBottom[14].emissiveColor = new BABYLON.Color3(0, emissiveColor, emissiveColor);
  ...
  render(projPixelSide, projPixelBack, projPixelBottom ){
    //if(projPixelSide != false){
      this.renderProjection(this.projPixelSideTemplate, projPixelSide, this.projPixelSide[0], this.materialsSide, 0, this.offsetY, 9.5, 0, 0);
      this.renderProjection(this.projPixelSideTemplate, projPixelSide, this.projPixelSide[1], this.materialsSide, 0, this.offsetY,  -0.5, 0, Math.PI);
    //}
    //if(projPixelBack != false){
    ...
    this.renderProjection(this.projPixelSideTemplate, projPixelBack, this.projPixelSide[3], this.materialsSide, -0.5, this.offsetY,  0, 0,  -Math.PI/2);
   // }
    //if(projPixelBottom != false){
