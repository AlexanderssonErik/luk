...
let guiGame = {
    ...
    init : function(scene ){
       ...
       // "./icon/game/tangram_free.svg"
        ...
        iconPathGame[0] = [];
        iconPathGame[0][0] = "./icon/game/guided_build.svg";
        ...
        iconPathGame[3][1] = "./icon/game/shape_hunter.svg";
...
//Games -------------- 
      for(let i =0; i < iconPathGame.length; i++){
        ...
        this.buttonsGame[0][2].initCallBack(this.clickGame, buttonTrigger.up);
        ...
        this.buttonsGame[2][0].initCallBack(this.clickGame, buttonTrigger.up);
        this.buttonsGame[2][1].initCallBack(this.clickGame, buttonTrigger.up);

        this.buttonsGame[3][0].initCallBack(this.clickGame, buttonTrigger.up);
        this.buttonsGame[3][1].initCallBack(this.clickGame, buttonTrigger.up);
